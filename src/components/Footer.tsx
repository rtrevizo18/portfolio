function Footer() {
  return (
    <footer
      id="contact"
      className="px-6 py-10 text-[0.8rem] uppercase tracking-[0.38em] text-white/50 sm:px-10 lg:px-14"
    >
      <div className="sm:text-2xl text-white/80 font-semibold">
        Get in Touch
      </div>
      <div className="mt-8 flex flex-col gap-4 text-[0.86rem] tracking-[0.2em] sm:flex-row sm:justify-around">
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            href="/Ricardo_Trevizo_Resume.pdf"
            target="_blank"
            rel="noreferrer"
            aria-label="Open resume"
            title="Resume"
          >
            <span className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/12 bg-white/5 transition-all hover:border-white/25 hover:bg-white/10">
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-5 w-5 fill-none stroke-current stroke-[1.7]"
              >
                <path d="M7 3.75h6.25L17.5 8v12.25A2.25 2.25 0 0 1 15.25 22h-8.5A2.25 2.25 0 0 1 4.5 19.75V6.25A2.5 2.5 0 0 1 7 3.75Z" />
                <path d="M13.25 3.75V8H17.5" />
                <path d="M8.25 11.5h7.5M8.25 14.5h7.5M8.25 17.5h4.5" />
              </svg>
            </span>
          </a>
        </div>

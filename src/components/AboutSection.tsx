...
function AboutSection() {
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col gap-10 lg:flex-row lg:items-center lg:justify-around lg:gap-8">
        <div className="order-2 max-w-4xl lg:order-1">
          <p className="mb-4 font-semibold uppercase tracking-[0.38em] text-white/80 sm:text-2xl">
            About
          </p>
          <h2 className="max-w-3xl font-title uppercase text-[clamp(2.4rem,7vw,6rem)] leading-[0.94] tracking-[0.03em] text-white">
            Creating Solutions
          </h2>
          <p className="mt-6 max-w-4xl text-xl tracking-wide leading-8 text-white/80 sm:text-2xl">
